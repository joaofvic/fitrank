-- Atualiza get_user_public_profile para retornar dados ricos nos recent_checkins,
-- compativeis com o componente FeedPostCard:
-- likes_count, comments_count, has_liked, feed_caption, created_at
