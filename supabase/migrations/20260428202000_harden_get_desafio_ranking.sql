-- Epic 5 (desafios-ranking-privado): Hardening anti-inferência
-- - Evita que não participantes acessem ranking completo via RPC antiga `get_desafio_ranking`
-- - Mantém a assinatura esperada (inclui avatar_url), mas só retorna durante desafio ativo e para participante
