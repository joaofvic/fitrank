  ...
  const loadProfile = useCallback(
    async (userId) => {
      ...
      const { data, error } = await supabase
        .from('profiles')
        .select(
          'id, display_name, nome, username, avatar_url, academia, pontos, streak, xp, league, is_pro, last_checkin_date, created_at, is_platform_master, tenant_id, onboarding_completed_at, tenants (slug, name, status)'
        )
        .eq('id', userId)
        .maybeSingle();
