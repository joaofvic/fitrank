...
export function ProCheckoutBricks({ supabase, plan }) {
  ...
  return (
    <Card className="border-zinc-800 bg-zinc-950/40 p-3 mt-3">
      <div className="min-w-0">
        <p className="text-sm font-bold">FitRank PRO</p>
        <p className="text-xs text-zinc-500">
          {plan?.name} • {formatMoneyBRL(plan?.price_amount)}
        </p>
      </div>
